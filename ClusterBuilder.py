...
class ClusterBuilder:
    ...
    def build(self):
        ...
        print("Updating cluster networking...")
    ...
    def connect_with_container(self, node_name: str, node_iface: NetIface, container_id: str, container_iface: NetIface,
        ...
        if add_default_route_via_container:
            iputils.add_default_route(node.netns_name, container_iface.ipv4)
    ...
    def _update_cluster_address_translatations(self):
        for worker1, worker2 in it.combinations(self.workers, 2):
            # iptables -t nat -A OUTPUT -d 172.18.0.3 -j DNAT --to-destination 10.10.0.2
            pass
