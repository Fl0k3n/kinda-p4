...
r2.update_meta(args={
    ...
    "exec_commands": [
        ...
        *simple_switch_CLI(
        ...
        "simple_switch_grpc -i 1@eth0 -i 2@eth1 int4.json",
    ]
})
...
r3.update_meta(args={
    ...
    "exec_commands": [
        ...
        *simple_switch_CLI(
        ...
        "simple_switch_grpc -i 1@eth0 -i 2@eth1 -i 3@eth2 int4.json",
    ]
})
...
p4c-bm2-ss --p4v 16 /p4/int.p4 --p4runtime-files int.txt,int.bin -o "int.json" -DBMV2
'''
