...
r1.update_meta(args={
    ...
    "exec_commands": [
        ...
        *simple_switch_CLI(
            ...
            'table_add ingress.Forward.ipv4_lpm ingress.Forward.ipv4_forward 10.10.4.0/24 => 00:00:0a:00:00:05 00:00:0a:00:00:06 2',
            ...
            'table_add tb_int_sink configure_sink 2 => 2',
            'mirroring_add 1 2',
            'table_add tb_int_reporting send_report 0.0.0.0/0 => 00:00:0a:00:00:05 10.10.2.1 00:00:0a:00:00:06 10.10.4.2 6000',
        ),
        "simple_switch -i 1@eth0 -i 2@eth1 int5.json",
    ]
})
...
r2.update_meta(args={
    ...
    "exec_commands": [
        ...
        *simple_switch_CLI(
            ...
            'table_add ingress.Forward.ipv4_lpm ingress.Forward.ipv4_forward 10.10.4.0/24 => 00:00:0a:00:00:07 00:00:0a:00:00:08 2',
            'table_add tb_int_transit configure_transit 0.0.0.0/0 => 2 1500',
            # 'table_add tb_int_sink configure_sink 2 => 2',
            # 'mirroring_add 1 2',
            # 'table_add tb_int_reporting send_report 0.0.0.0/0 => 00:00:0a:00:00:07 10.10.3.1 00:00:0a:00:00:08 10.10.4.2 6000',
        ),
        "simple_switch -i 1@eth0 -i 2@eth1 int5.json",
    ]
})
...
r3.update_meta(args={
    ...
    "exec_commands": [
        ...
        *simple_switch_CLI(
            ...
            'table_add ingress.Forward.ipv4_lpm ingress.Forward.ipv4_forward 10.10.4.2/32 => 00:00:0a:00:00:0a 00:00:0a:00:00:03 3',
        ...
        "simple_switch -i 1@eth0 -i 2@eth1 -i 3@eth2 int5.json",
    ]
})
